...
const Footer = () => {
  return (
    <div className="relative bg-gradient-to-br from-[#3b89e7] via-[#3a8ae6] to-[#00cf99] px-4 pt-24 md:px-[140px] md:pt-[200px]">
      <div className="absolute left-0 top-0 w-full rotate-180 overflow-hidden leading-[0px]">
        <svg
          ...
          className="relative block w-full md:h-[75px]"
        >
          <path
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex max-w-sm flex-col items-center justify-center gap-y-8 text-white md:items-start md:justify-start">
          <img
            src="https://www.xendit.co/wp-content/uploads/2019/11/xendit-logo-white.svg"
            className="h-[47px] w-[165px]"
          />
          <div className="text-center font-montserrat text-base font-bold md:text-xl">
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <div className="flex flex-row items-center justify-start">
              <input
                type="email"
                className="w-56 rounded-l-lg p-4"
        ...
        <div className="grid grid-cols-2 grid-rows-2 md:grid-cols-4 md:grid-rows-1">
          <div className="flex flex-col pt-24 text-white md:pl-16 md:pt-0">
          ...
          <div className="flex flex-col pt-8 text-white md:pl-16 md:pt-0">
      ...
      <hr className="mb-4 w-full md:mb-12 md:mt-8" />
      <div className="flex flex-col items-center md:flex-row md:items-start md:justify-between">
        <div className="flex flex-col gap-y-8 md:gap-y-4">
          <div className="mt-4 flex flex-row gap-x-4">
            <img
              ...
              className="h-[49px] w-[164px] md:h-[54px] md:w-[182px]"
            />
            <img
          ...
          <div className="flex flex-row items-center justify-center gap-x-2 md:items-start md:justify-start">
        ...
        <div className="mt-8 flex flex-col gap-y-6 md:mt-0">
          <div className="hidden flex-row md:flex">
            <img
              src="https://www.xendit.co/wp-content/uploads/2019/12/ServiceProviderBadge-1-150x150-1.webp"
              className="h-[84px] w-[84px]"
              alt=""
            />
            <img
              src="https://www.xendit.co/wp-content/uploads/2019/12/TR-Testmark_0000065832_EN_CMYK_without-QR-Code_hi-res-01-1.webp"
              className="h-[83px] w-[165px]"
              alt=""
            />
            <img
              src="https://www.xendit.co/wp-content/uploads/2019/12/Xendit-Certificate-Bank-Indonesia-hires-min.webp"
              className="ml-2 h-[84px] w-[219px] rounded-lg"
              alt=""
            />
          </div>
          ...
          <div className="text-center font-montserrat text-sm font-light text-white md:text-right">
            © 2023 Xendit (PT Sinar Digital Terdepan). All rights reserved.
            <br />
            <a href="#">Kebijakan Privasi | Syarat & Ketentuan</a>
          </div>
        </div>
      </div>
      <div className="flex flex-row gap-x-4 px-6 py-12 md:px-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="font-montserrat text-sm font-light text-white">
          <strong className="font-bold">
            Waspadalah terhadap Upaya Penipuan
          </strong>{" "}
          Xendit bukan perusahaan peer to peer lending dan tidak memiliki produk
          pinjaman pribadi. Jika Anda menemukan usaha penipuan yang
          mengatasnamakan Xendit, informasikan segera ke help@xendit.co atau via
          live chat.
        </div>
      </div>
    </div>
