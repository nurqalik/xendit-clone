...
const Footer = () => {
  return (
    <div className="relative bg-gradient-to-br from-[#3b89e7] via-[#3a8ae6] to-[#00cf99] px-4 md:px-[140px] pt-24 md:pt-[200px]">
      <div className="absolute left-0 top-0 w-full rotate-180 overflow-hidden leading-[0px]">
        <svg
          ...
          className="relative block md:h-[75px] w-full"
        >
          <path
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex max-w-sm flex-col gap-y-8 items-center md:items-start md:justify-start justify-center text-white">
          <img
            src="https://www.xendit.co/wp-content/uploads/2019/11/xendit-logo-white.svg"
            className="h-[47px] w-[165px]"
          />
          <div className="font-bold font-montserrat text-base md:text-xl text-center">
        ...
        <div className="flex flex-col pt-24 md:pt-0 md:pl-16 text-white">
        ...
        <div className="flex flex-col pt-8 md:pt-0 md:pl-16 text-white">
      ...
      <hr className="mb-4 md:mb-12 md:mt-8 w-full" />
      <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between">
        <div className="flex flex-col gap-y-8 md:gap-y-4">
          <div className="mt-4 flex flex-row gap-x-4">
            <img
              ...
              className="h-[49px] md:h-[54px] w-[164px] md:w-[182px]"
            />
            <img
          ...
          <div className="flex flex-row items-center md:items-start md:justify-start justify-center gap-x-2">
        ...
        <div className="flex flex-col gap-y-6 mt-8 md:mt-0">
          ...
          <div className="flex md:hidden flex-col items-center justify-center gap-y-2">
