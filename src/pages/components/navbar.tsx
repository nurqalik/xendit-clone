...
export default function Navbar() {
  return (
    <div className="sticky top-0 z-[100]">
      <div className="flex h-11 w-full items-center justify-center bg-gradient-to-r from-[#9937FD] to-[#ff9900] py-[20px]">
      ...
      <nav className="h-[87px] w-full bg-[#4373FC]">
        <div className="flex h-full flex-row items-center justify-center gap-x-6">
          <img
            src={
